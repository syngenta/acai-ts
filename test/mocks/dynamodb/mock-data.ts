...
export const getData = (): DynamoDBStreamEvent => {
    return {
        Records: [
            {
...
export const getTTLData = (): DynamoDBStreamEvent => {
    return {
        Records: [
            {
                eventID: '9a37c0d03eb60f7cf70cabc823de9907',
...
export const getUpdateData = (): DynamoDBStreamEvent => {
    return {
        Records: [
            {
                eventID: '9a37c0d03eb60f7cf70cabc823de9907',
...
export const getDeletedData = (): DynamoDBStreamEvent => {
    return {
        Records: [
            {
                eventID: '9a37c0d03eb60f7cf70cabc823de9907',
